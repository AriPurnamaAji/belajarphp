...
<!-- NAVBAR -->
    ...
    <b>Detail Buku</b><hr>
        <table align="center">
        <tr>
            <td colspan=3 style="text-align:center;"><img src="https://inlislite.uin-suska.ac.id/uploaded_files/sampul_koleksi/original/Monograf/13510.jpg" width=200px><hr></td>
        </tr>
        <tr>
            <td>Judul</td>
            <td>:</td>
