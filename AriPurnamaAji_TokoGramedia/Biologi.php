...
<!-- NAVBAR -->
    ...
    <b>Detail Buku</b><hr>
        <table align="center">
        <tr>
            <td colspan=3 style="text-align:center;"><img src="https://image.gramedia.net/rs:fit:0:0/plain/https://cdn.gramedia.com/uploads/items/9786023742998_sma_ma_kl_12_biologi_3_u_siswa_pemintan_k.2013-revis.jpg" width=200px><hr></td>
        </tr>
        <tr>
            <td>Judul</td>
            <td>:</td>
