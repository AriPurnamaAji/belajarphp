...
<!-- NAVBAR -->
    ...
    <b>Detail Buku</b><hr>
        <table>
        <tr>
            <td colspan=3 style="text-align:center;"><img src="https://image.gramedia.net/rs:fit:0:0/plain/https://cdn.gramedia.com/uploads/items/9786022995111_SMA-KL.XI-FIS.jpg" width=200px><hr></td>
        </tr>
        <tr>
            <td>Judul</td>
            <td>:</td>
